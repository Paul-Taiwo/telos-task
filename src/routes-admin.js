...
const ViewAllTask = React.lazy(() => import('./views/TaskCompleted/TaskCompleted'));
...
const routes = [
  ...
  { path: "/admin/profile", name: "Admin Profile", component: UserProfile },
  ...
  { path: "/admin/create-task", name: "Create Task", component: CreateTask },
  { path: "/base/switches", name: "Switches", component: Switches },
  { path: "/admin/view-all-task", name: "View All Task", component: ViewAllTask },
